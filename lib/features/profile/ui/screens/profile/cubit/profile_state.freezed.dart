...
abstract class Initial<T> implements ProfileState<T> {
...
class __$$FailureImplCopyWithImpl<T, $Res>
    extends _$ProfileStateCopyWithImpl<T, $Res, _$FailureImpl<T>>
...
class _$FailureImpl<T> implements Failure<T> {
  ...
  @override
  String toString() {
    return 'ProfileState<$T>.failure(errorMsg: $errorMsg)';
  }
...
abstract class Failure<T> implements ProfileState<T> {
  const factory Failure(final String errorMsg) = _$FailureImpl<T>;
